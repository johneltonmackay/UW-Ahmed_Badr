        ...
        const SUITELET = {
            ...
            form: {
                ...
                fields: {
                    ...
                    TOTAL_REG_EARNING: {
                        id: "custpage_total_reg_earning",
                        type: "TEXT",
                        label: "Total Reg Earnings",
                        ishidden: false,
                        isdisabled: true
                    },
                    TOTAL_OT_EARNING: {
                        id: "custpage_total_ot_earning",
                        type: "TEXT",
                        label: "Total O/T Earnings",
                        ishidden: false,
                        isdisabled: true
                    },
                    TOTAL_STH_EARNING: {
                        id: "custpage_total_earning_sth",
                        type: "TEXT",
                        label: "Total Earning STH",
                        ishidden: false,
                        isdisabled: true
                    },
                    TOTAL_S15_EARNING: {
                        id: "custpage_total_earning_s15",
                        type: "TEXT",
                        label: "Total Earning S15",
                        ishidden: false,
                        isdisabled: true
                    },
                    TOTAL_SCK_EARNING: {
                        id: "custpage_total_earning_sck",
                        type: "TEXT",
                        label: "Total Earning SCK",
                        ishidden: false,
                        isdisabled: true
                    },
                    TOTAL_EXP_EARNING: {
                        id: "custpage_total_earning_exp",
                        type: "TEXT",
                        label: "Total Earning EXP",
                        ishidden: false,
                        isdisabled: true
                    },
                    TOTAL_VAC_EARNING: {
                        id: "custpage_total_earning_vac",
                        type: "TEXT",
                        label: "Total Earning VAC",
                        ishidden: false,
                        isdisabled: true
                    },
                },
