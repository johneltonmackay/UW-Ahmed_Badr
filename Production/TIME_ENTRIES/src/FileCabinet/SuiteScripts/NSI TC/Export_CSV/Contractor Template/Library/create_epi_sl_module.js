 ...
 * @NAPIVersion 2.1
 */
define(["N/ui/serverWidget", "N/search", "N/task", "N/file", "N/record", "../Library/create_epi_sl_mapping.js", 'N/runtime', 'N/url', 'N/ui/message', 'N/format'],
        ...
        ACTIONS.RunMR = (options) => {
            ...
            try {
                ...
                var MapReduceTask = task.create({
                    ...
                    params: {
                        custscript_epi_data: JSON.stringify(objParamMR)
                    }
                });
                            ...
                            if (value){
                                if (key == 'custpage_view'){
                                    var strEPIChildRecUrl = url.resolveRecord({
                                        recordType: 'customrecord_epi4a110_child',
                                        recordId: value
                                    });
                                    ...
                                    var strEPIParentRecUrl = url.resolveRecord({
                                        recordType: 'customrecord_epi4a110_parent',
                                        recordId: value
                                    });
        ...
        const runViewSearch = (paramTransKey) => {
            ...
            try {
                ...
                let objSavedSearch = search.create({
                    ...
                    filters: [
                        ['custrecord_transaction_keys', 'is', strTransKey],
                    ],
                    columns: [
                        search.createColumn({ name: 'internalid', label: 'custpage_view'}),
                        search.createColumn({ name: 'custrecord_remarks', label: 'custpage_remarks'}),
                        search.createColumn({ name: 'custrecord_co_code_col_01', label: 'custpage_co_code_col_01'}),
                        search.createColumn({ name: 'custrecord_batch_id_col_02', label: 'custpage_batch_id_col_02'}),
                        search.createColumn({ name: 'custrecord_file_no_col_03', label: 'custpage_file_no_col_03'}),
                        search.createColumn({ name: 'custrecord_earn_5_code_col_04', label: 'custpage_earn_5_code_col_04'}),
                        search.createColumn({ name: 'custrecord_earn_5_amount_col_05', label: 'custpage_earn_5_amount_col_05'}),
                        search.createColumn({ name: 'custrecord_earn_5_code_col_06', label: 'custpage_earn_5_code_col_06'}),
                        search.createColumn({ name: 'custrecord_earn_5_amount_col_07', label: 'custpage_earn_5_amount_col_07'}),
                        search.createColumn({ name: 'custrecord_earn_5_code_col_08', label: 'custpage_earn_5_code_col_08'}),
                        search.createColumn({ name: 'custrecord_earn_5_amount_col_09', label: 'custpage_earn_5_amount_col_09'}),
                        search.createColumn({ name: 'custrecord_parent_record_id', label: 'custpage_parent_record_id'}),
