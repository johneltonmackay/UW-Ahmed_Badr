            ...
            try {
                let objSearch = search.create({
                    ...
                    columns: [
                        ...
                        search.createColumn({ name: 'custrecord_epia0f11_earn_code_exp_col_23' }),
                        search.createColumn({ name: 'custrecord_epia0f11_earn_amt_exp_col_24' }),
                        ...
                        if (pageData.length > 0) {
                            for (var pageResultIndex = 0; pageResultIndex < pageData.length; pageResultIndex++) {
                                arrPayrollRecordData.push({
                                    ...
                                    epia0f11_earn_code_exp_col_23: pageData[pageResultIndex].getValue({name: 'custrecord_epia0f11_earn_code_exp_col_23'}),
                                    epia0f11_earn_amt_exp_col_24: pageData[pageResultIndex].getValue({name: 'custrecord_epia0f11_earn_amt_exp_col_24'}),
